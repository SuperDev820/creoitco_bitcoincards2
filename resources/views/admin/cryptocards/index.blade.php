...
@section('page_content')
    <div class="box">
        <div class="box-body">
            <form class="form-horizontal" action="{{ url('admin/cryptocards') }}" method="GET" id='cryptocard_form'>
                ...
                <div class="col-md-12">
                    <div class="panel panel-info">
                        <div class="panel-heading">
                            <div class="row">
                                <div class="col-md-10">
                                    <h3 class="panel-title">Cryptocards</h3>
                                </div>
    ...
    $(document).ready(function()
    {
        ...
        $('#user_input').autocomplete(
        {
            source:function(req,res)
            {
                ...
                {
                    $.ajax({
                        url:'{{url('admin/cryptocards_user_search')}}',
                        dataType:'json',
                        type:'get',
                        data:{
                            search:req.term
