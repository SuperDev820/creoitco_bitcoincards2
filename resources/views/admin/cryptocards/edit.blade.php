        ...
        <div class="col-md-12">
            <div class="box box-info">
                <div class="box-header with-border text-center">
                    <h3 class="box-title">Update Cryptocard</h3>
                </div>
                <form action="{{ url('admin/cryptocards/update') }}" class="form-horizontal" id="cryptocard_form" method="POST">
                    <input type="hidden" value="{{csrf_token()}}" name="_token" id="token">
                    <input type="hidden" value="{{ $cryptocards->id }}" name="id" id="id" />
                        <div class="box-body">
                            <div class="form-group">
                                <label class="control-label col-sm-3" for="code">Code</label>
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" name="code" value="{{ $cryptocards->code }}" id="code">
                                    @if($errors->has('code'))
                                        <span class="error">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" name="BTC" value="{{ $cryptocards->BTC }}" id="BTC"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" name="BTC_EUR" value="{{ $cryptocards->BTC_EUR }}" id="BTC_EUR"
                                    oninput="restrictNumberToEightdecimals(this)">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" name="EUR" value="{{ $cryptocards->EUR }}" id="EUR"
                                    oninput="restrictNumberToEightdecimals(this)">
                                    @if($errors->has('EUR'))
                                        <span class="error">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <select class="select2" name="status" id="status">
                                        <option value='Activate' {{ $cryptocards->status == 1? 'selected':""}}>Activate</option>
                                        <option value='Deactivate' {{ $cryptocards->status == 2? 'selected':""}}>Deactivate</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" name="user" value="{{ $user->first_name.' '.$user->last_name }}" id="user">
                                    @if($errors->has('user'))
                                        <span class="error">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type="number" class="form-control" name="wallet_id" value="{{ $cryptocards->wallet_id }}" id="wallet_id">
                            ...
                            <div class="box-footer">
                                ...
                                <button type="submit" class="btn btn-primary pull-right btn-flat" id="cryptocards_edit"><i class="fa fa-spinner fa-spin" style="display: none;"></i> <span id="cryptocards_edit_text">Update</span></button>
                            </div>
                        </div>
                    </input>
                </form>
...
<script type="text/javascript">
    ...
    $('#cryptocard_form').validate({
        ...
        {
            $("#cryptocards_edit").attr("disabled", true);
            $(".fa-spin").show();
            $("#cryptocards_edit_text").text('Updating...');
            $('#cryptocards_cancel').attr("disabled",true);
            $('#cryptocards_edit').click(function (e) {
                e.preventDefault();
            });
            form.submit();
        }
