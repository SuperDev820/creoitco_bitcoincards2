...
<html lang="en">
	    <head>
			...
			<link rel="stylesheet" type="text/css" href="{{ asset('user_dashboard/css/sweetalert/sweetalert.css')}}">
	...
	<!-- sweetalert -->
	<script src="{{ asset('user_dashboard/css/sweetalert/sweetalert.min.js')}}" type="text/javascript"></script>
